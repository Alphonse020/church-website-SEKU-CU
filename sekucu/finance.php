...
<!-- end of nav bar -->
   <section class="ftco-counter ftco-intro" id="section-counter">
            ...
            <div class="block-18 color-2 align-items-stretch">
              <div class="text">
               <h3 class="mb-4">Offerings:</h3> 
                ...
                <span>Collected on: Sunday November. 01, 2020 Thank you all. Be blessed.</span>
              </div>
            </div>
          </div>
    ...
    <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              <div class="icon d-flex mb-3"></div>
              <div class="media-body pl-4">
                <h2 class="heading"> PAYMENT METHODS</h2>
              <p>Payment Via M-PESA Can Be Made Through</p>
          
        <img src="images/paybill.jpg" height="200px" width="300px">
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 d-flex services p-3 py-4 d-block">
              <div class="icon d-flex mb-3"></div>
              <div class="media-body pl-4">
                  <li>PAYBILL: <strong> 222112  </strong></li>
        <li>Mobile number: <strong>0722211222 </strong> </li>
       <li>Treasurer or any  relevant finance official (CASH) <strong> -Samuel Kirori  </strong></li>
              </div>
            </div>    
          </div>
        </div>
