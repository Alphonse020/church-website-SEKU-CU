...
<!-- my favicon -->
  ...
  <body>
    ...
    <div>
      ...
      <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="index.php">Gallery</a><a class="dropdown-item" role="presentation" href="../sekucu-videos/">Videos</a></div>  </li>
    	...
    	<div class="container">
	    	...
	    	<div class="d-md-flex">
		    	...
		    	<a href="images/image_1.JPG" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(images/image_1.JPG);">
		    		...
		    		<a href="images/event-4.JPG" class="gallery image-popup d-flex justify-content-center align-items-center img ftco-animate" style="background-image: url(images/event-4.JPG);">
		    		<div class="icon d-flex justify-content-center align-items-center">
		    			<span class="icon-search"></span>
		    		</div>
		    	</a>
