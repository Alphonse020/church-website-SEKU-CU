                    ...
                    <div id="wrapper">
                         <div id="login">
                            ...
                            <form action="dbh_bbs.php" method="POST"> 
                                ...
                                <p> 
                                 <label for="name" class="uname" > Full Name: </label>
                                    <input id="name" name="fname"  type="text"  maxlength="50" style="font-weight: bold; font-size: 14px;"  value="<?php echo(htmlspecialchars($_SESSION['login_user']));  echo " " .(htmlspecialchars($_SESSION['sname'])); ?>" />
                                </p>
                     	
                  				       <p> 
                                    <label for="mobile" class="uname" >Mobile Number/Registration Number: </label>
                                    <input id="mobile" name="mobile" type="text" style="font-weight: bold; font-size: 14px;" maxlength="10" placeholder="i.e 0712345678" value="<?php echo(htmlspecialchars($_SESSION['mobile'])); ?>"/> 
                                </p>		

                                	<p> 
                                <label for="usernamesignup"  class="uname">Gender</label>
                                <select style="font-weight: bold; font-size: 14px;" name="gender" id="usernamesignup" required="required" type="text">
                               <!--  <OPTION label="--Select Gender--" ></OPTION> -->
                               <option  value="<?php echo(htmlspecialchars($_SESSION['Gender'])); ?>">Male</option>
